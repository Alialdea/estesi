...
export const Mutation = {
    ...
    Promise<ContactoModelType>=>{
        ...
        if (args.apellido1) contactoactualizar.apellido1 = args.apellido1;
        if (args.apellido2) contactoactualizar.apellido2 = args.apellido2;
        if (args.ntelefono) contactoactualizar.ntelefono = args.ntelefono;
